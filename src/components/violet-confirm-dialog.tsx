  ...
  (
    ...
    <AlertDialogPrimitive.Root open={open} onOpenChange={onOpenChange}>
      ...
      <AlertDialogPrimitive.Portal>
        ...
        >
          {showCloseButton && (
            <AlertDialogPrimitive.Cancel className="absolute right-4 top-4 -m-2 rounded-sm p-2 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
              <CloseIcon />
