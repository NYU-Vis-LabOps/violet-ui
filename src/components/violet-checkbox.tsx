...
const VioletCheckbox = React.forwardRef<
  ...
  >
    <CheckboxPrimitive.Indicator className="flex items-center justify-center text-current">
      {props.checked === "indeterminate" ? (
        <svg width="9" height="9" viewBox="0 0 15 15" fill="none" className="h-3 w-3">
          <path
            d="M2.25 7.5a.75.75 0 0 1 .75-.75h9a.75.75 0 0 1 0 1.5H3a.75.75 0 0 1-.75-.75Z"
            fill="currentColor"
          />
        </svg>
      ) : (
...
VioletCheckbox.displayName = "VioletCheckbox"

export { VioletCheckbox }
