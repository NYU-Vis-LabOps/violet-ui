...
| `violet-autocomplete-input` | Input-backed autocomplete with local filtering, remote loading, and custom values |
...
| `violet-combobox` | Autocomplete combobox with search, grouping, custom value support, and nested-scroll support |
| `violet-confirm-dialog` | Confirmation dialog with default, destructive, and opt-in overlay dismissal modes |
