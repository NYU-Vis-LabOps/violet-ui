...
|-----------|-----------|---------|
| Switch | radix-ui/Switch | Toggle controls for settings/preferences |
| Progress | radix-ui/Progress | Upload progress, approval workflow step bars |
| ConfirmDialog | radix-ui/AlertDialog | Destructive action confirmation (delete, revoke) |
